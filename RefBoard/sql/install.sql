...
CREATE TABLE IF NOT EXISTS matches (
  ...
  reopened_by_license VARCHAR(64) NULL,
  reopened_by_name VARCHAR(64) NULL,
...
CREATE TABLE IF NOT EXISTS match_players (
  ...
  ejected_at_ms BIGINT NULL,
  ejection_reason VARCHAR(64) NULL,
...
CREATE TABLE IF NOT EXISTS match_events (
  ...
  penalty_success TINYINT(1) NULL,
