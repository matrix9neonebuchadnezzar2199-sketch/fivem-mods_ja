-- RefBoard 開発用: 5 チーム投入済み前提で試合 20 件を追加する
-- 同一 match_name + created_by_license=seed:dev が既にある行は INSERT しない（リソース再起動でも重複しない）
...
WHERE t1.name = 'Los Santos FC' AND t1.deleted_at IS NULL
  AND NOT EXISTS (SELECT 1 FROM matches m WHERE m.created_by_license = 'seed:dev' AND m.match_name = '開発用試合01' LIMIT 1)
LIMIT 1;
...
WHERE t1.name = 'Vinewood United' AND t1.deleted_at IS NULL
  AND NOT EXISTS (SELECT 1 FROM matches m WHERE m.created_by_license = 'seed:dev' AND m.match_name = '開発用試合02' LIMIT 1)
LIMIT 1;
...
WHERE t1.name = 'Paleto Bay SC' AND t1.deleted_at IS NULL
  AND NOT EXISTS (SELECT 1 FROM matches m WHERE m.created_by_license = 'seed:dev' AND m.match_name = '開発用試合03' LIMIT 1)
LIMIT 1;
...
WHERE t1.name = 'Sandy Shores AC' AND t1.deleted_at IS NULL
  AND NOT EXISTS (SELECT 1 FROM matches m WHERE m.created_by_license = 'seed:dev' AND m.match_name = '開発用試合04' LIMIT 1)
LIMIT 1;
...
WHERE t1.name = 'Grapeseed Town FC' AND t1.deleted_at IS NULL
  AND NOT EXISTS (SELECT 1 FROM matches m WHERE m.created_by_license = 'seed:dev' AND m.match_name = '開発用試合05' LIMIT 1)
LIMIT 1;
...
FROM teams t1 JOIN teams t2 ON t2.name = 'Vinewood United' AND t2.deleted_at IS NULL
WHERE t1.name = 'Los Santos FC' AND t1.deleted_at IS NULL
  AND NOT EXISTS (SELECT 1 FROM matches m WHERE m.created_by_license = 'seed:dev' AND m.match_name = '開発用試合06' LIMIT 1)
LIMIT 1;
...
FROM teams t1 JOIN teams t2 ON t2.name = 'Paleto Bay SC' AND t2.deleted_at IS NULL
WHERE t1.name = 'Vinewood United' AND t1.deleted_at IS NULL
  AND NOT EXISTS (SELECT 1 FROM matches m WHERE m.created_by_license = 'seed:dev' AND m.match_name = '開発用試合07' LIMIT 1)
LIMIT 1;
...
FROM teams t1 JOIN teams t2 ON t2.name = 'Sandy Shores AC' AND t2.deleted_at IS NULL
WHERE t1.name = 'Paleto Bay SC' AND t1.deleted_at IS NULL
  AND NOT EXISTS (SELECT 1 FROM matches m WHERE m.created_by_license = 'seed:dev' AND m.match_name = '開発用試合08' LIMIT 1)
LIMIT 1;
...
FROM teams t1 JOIN teams t2 ON t2.name = 'Grapeseed Town FC' AND t2.deleted_at IS NULL
WHERE t1.name = 'Sandy Shores AC' AND t1.deleted_at IS NULL
  AND NOT EXISTS (SELECT 1 FROM matches m WHERE m.created_by_license = 'seed:dev' AND m.match_name = '開発用試合09' LIMIT 1)
LIMIT 1;
...
FROM teams t1 JOIN teams t2 ON t2.name = 'Los Santos FC' AND t2.deleted_at IS NULL
WHERE t1.name = 'Grapeseed Town FC' AND t1.deleted_at IS NULL
  AND NOT EXISTS (SELECT 1 FROM matches m WHERE m.created_by_license = 'seed:dev' AND m.match_name = '開発用試合10' LIMIT 1)
LIMIT 1;
...
FROM teams t1 JOIN teams t2 ON t2.name = 'Vinewood United' AND t2.deleted_at IS NULL
WHERE t1.name = 'Los Santos FC' AND t1.deleted_at IS NULL
  AND NOT EXISTS (SELECT 1 FROM matches m WHERE m.created_by_license = 'seed:dev' AND m.match_name = '開発用試合11' LIMIT 1)
LIMIT 1;
...
FROM teams t1 JOIN teams t2 ON t2.name = 'Paleto Bay SC' AND t2.deleted_at IS NULL
WHERE t1.name = 'Vinewood United' AND t1.deleted_at IS NULL
  AND NOT EXISTS (SELECT 1 FROM matches m WHERE m.created_by_license = 'seed:dev' AND m.match_name = '開発用試合12' LIMIT 1)
LIMIT 1;
...
FROM teams t1 JOIN teams t2 ON t2.name = 'Sandy Shores AC' AND t2.deleted_at IS NULL
WHERE t1.name = 'Paleto Bay SC' AND t1.deleted_at IS NULL
  AND NOT EXISTS (SELECT 1 FROM matches m WHERE m.created_by_license = 'seed:dev' AND m.match_name = '開発用試合13' LIMIT 1)
LIMIT 1;
...
FROM teams t1 JOIN teams t2 ON t2.name = 'Grapeseed Town FC' AND t2.deleted_at IS NULL
WHERE t1.name = 'Sandy Shores AC' AND t1.deleted_at IS NULL
  AND NOT EXISTS (SELECT 1 FROM matches m WHERE m.created_by_license = 'seed:dev' AND m.match_name = '開発用試合14' LIMIT 1)
LIMIT 1;
...
FROM teams t1 JOIN teams t2 ON t2.name = 'Los Santos FC' AND t2.deleted_at IS NULL
WHERE t1.name = 'Grapeseed Town FC' AND t1.deleted_at IS NULL
  AND NOT EXISTS (SELECT 1 FROM matches m WHERE m.created_by_license = 'seed:dev' AND m.match_name = '開発用試合15' LIMIT 1)
LIMIT 1;
...
FROM teams t1 JOIN teams t2 ON t2.name = 'Vinewood United' AND t2.deleted_at IS NULL
WHERE t1.name = 'Los Santos FC' AND t1.deleted_at IS NULL
  AND NOT EXISTS (SELECT 1 FROM matches m WHERE m.created_by_license = 'seed:dev' AND m.match_name = '開発用試合16' LIMIT 1)
LIMIT 1;
...
FROM teams t1 JOIN teams t2 ON t2.name = 'Paleto Bay SC' AND t2.deleted_at IS NULL
WHERE t1.name = 'Vinewood United' AND t1.deleted_at IS NULL
  AND NOT EXISTS (SELECT 1 FROM matches m WHERE m.created_by_license = 'seed:dev' AND m.match_name = '開発用試合17' LIMIT 1)
LIMIT 1;
...
FROM teams t1 JOIN teams t2 ON t2.name = 'Sandy Shores AC' AND t2.deleted_at IS NULL
WHERE t1.name = 'Paleto Bay SC' AND t1.deleted_at IS NULL
  AND NOT EXISTS (SELECT 1 FROM matches m WHERE m.created_by_license = 'seed:dev' AND m.match_name = '開発用試合18' LIMIT 1)
LIMIT 1;
...
FROM teams t1 JOIN teams t2 ON t2.name = 'Grapeseed Town FC' AND t2.deleted_at IS NULL
WHERE t1.name = 'Sandy Shores AC' AND t1.deleted_at IS NULL
  AND NOT EXISTS (SELECT 1 FROM matches m WHERE m.created_by_license = 'seed:dev' AND m.match_name = '開発用試合19' LIMIT 1)
LIMIT 1;
...
FROM teams t1 JOIN teams t2 ON t2.name = 'Los Santos FC' AND t2.deleted_at IS NULL
WHERE t1.name = 'Grapeseed Town FC' AND t1.deleted_at IS NULL
  AND NOT EXISTS (SELECT 1 FROM matches m WHERE m.created_by_license = 'seed:dev' AND m.match_name = '開発用試合20' LIMIT 1)
LIMIT 1;
