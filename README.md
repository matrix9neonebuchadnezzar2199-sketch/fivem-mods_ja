...
- [文字コード方針（UTF-8・BOM 禁止）](docs/CHARACTER-ENCODING.md)
...
- [jp-gacha](jp-gacha/README.md) — ガチャ（NUI演出・1連/10連・現金支払い）
- [jp-gacha2](jp-gacha2/README.md) — ガチャv2（ox_inventory・管理画面・NUI カプセル演出）
