...
--[[
  jp-v-farming 設定
  表示文言は locales と labelKey 経由（Config.Locale で切替）。
]]
...
-- v-supplychain-restaurants 連携（true の場合、売却分が倉庫在庫に加算される想定）
Config.useMyResturantWarehouseScript = true

-- サーバーイベント不正利用が疑われる場合にキックする
Config.DropPlayerOnExploitCheck = true
...
-- 買取地点のマップブリップ（表示名は client 側で _U('SELLER_BLIP_LABEL') を使用）
Config.SellerBlip = {
    label = 'Fruit Buyer',
    coords = vector3(2564.3635, 4680.3677, 33.0768),
    blipSprite = 1,
...
Config.ItemsFarming = {
    ...
    ['orange'] = { label = 'Orange', labelKey = 'ITEM_ORANGE', price = 4 },
    ['pear'] = { label = 'Pear', labelKey = 'ITEM_PEAR', price = 4 },
    ['cherry'] = { label = 'Cherry', labelKey = 'ITEM_CHERRY', price = 4 },
    ['peach'] = { label = 'Peach', labelKey = 'ITEM_PEACH', price = 4 },
    ['banana'] = { label = 'Banana', labelKey = 'ITEM_BANANA', price = 4 },
    ['strawberry'] = { label = 'Strawberry', labelKey = 'ITEM_STRAWBERRY', price = 4 },
    ['blueberry'] = { label = 'Blueberry', labelKey = 'ITEM_BLUEBERRY', price = 4 },
    ['grape'] = { label = 'Grape', labelKey = 'ITEM_GRAPE', price = 4 },
    ['kiwi'] = { label = 'Kiwi', labelKey = 'ITEM_KIWI', price = 4 },
    ['lemon'] = { label = 'Lemon', labelKey = 'ITEM_LEMON', price = 4 },
    ['mango'] = { label = 'Mango', labelKey = 'ITEM_MANGO', price = 4 },
    ['watermelon'] = { label = 'Watermelon', labelKey = 'ITEM_WATERMELON', price = 4 },
    ['milk'] = { label = 'Milk', labelKey = 'ITEM_MILK', price = 4 },
}
