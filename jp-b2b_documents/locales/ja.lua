...
Locale = {
    ...
    ui_modal_lock_title  = "ロック（署名）の確認",
    ui_modal_lock_desc   = "ロックすると編集できなくなります（解除は別途運用が必要です）。実行しますか？",
    ui_btn_cancel        = "キャンセル",
    ui_btn_copy          = "複製する",
    ui_btn_lock_confirm  = "ロックする",
    ui_size_normal       = "標準",
    ui_size_small        = "小",
    ui_size_large        = "大",
    ui_size_title        = "見出し",
    ui_font_default      = "デフォルト",
    ui_font_noto_sans    = "Noto Sans ゴシック",
    ui_font_noto_serif   = "Noto Serif 明朝",
    ui_font_shippori     = "しっぽり明朝",
    ui_font_klee         = "クレー One",
    ui_font_yuji_mai     = "游明朝体 舞",
    ui_font_zen          = "Zen クレナイド",
