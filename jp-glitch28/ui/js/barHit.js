...
let barHitGame = {
    ...
    setupRound: function() {
        ...
        $('#bar-hit-message').text('バーがゾーンに入ったとき [' + this.config.key + '] を押す');
    ...
    handlePress: function() {
        ...
        if (inZone) {
            ...
            $('#bar-hit-message').text('ミス — 残り ' + (this.config.maxFailures - this.failures));
    ...
    endGame: function(success) {
        ...
        $('#bar-hit-message').text(success ? 'アクセス許可' : 'アクセス拒否');
