...
let aimTestGame = {
    ...
    endGame: function(success) {
        ...
        $result.html(success ? 
            '目標捕捉！<br><span class="result-stats">' + this.targetsHit + '/' + this.config.targetsToHit + ' ヒット</span>' : 
            '目標喪失！<br><span class="result-stats">' + this.targetsHit + '/' + this.config.targetsToHit + ' ヒット</span>'
        );
