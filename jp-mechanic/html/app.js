...
(function () {
    ...
    function errMsgForShift(reason) {
        ...
        if (reason === 'nokarte') {
            return '出題庫が空です（data/slips_*.lua 読込を確認）';
        }
        if (reason === 'noconfig') {
            return '難易度設定に失敗しました';
        }
    ...
    function renderDifficulties(list) {
        ...
        (list || []).forEach(function (d) {
            ...
            b.addEventListener('click', function (e) {
                e.preventDefault();
                postcb('mechanicSelectDifficulty', { id: d.id });
            });
    ...
    function doPack() {
        ...
        postcb('mechanicKarteSubmit', { sessionId: currentSession.id, selectedIds: sel });
    }
    ...
    function showSuccessAndNext() {
        ...
        setTimeout(function () {
            ...
            postcb('mechanicRequestNextKarte', {});
        }, 800);
    }
