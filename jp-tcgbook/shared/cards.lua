...
TcgCardsMaster = {
    ...
    },
    {
        ...
        description = '金刺繍の外套とリュートで道を彩る若き吟遊詩人。華やかだが盤面は地味。',
        description_en = 'A young bard in gold-embroidered finery and a lute—flashy look, modest stats.',
        no = 17,
    },
    {
        card_id = 'tcg_c_rat',
        name = '紺鉄の若侍',
        name_en = 'Indigo Steel Samurai',
        rank = 'C',
        type = 'free',
        stat_top = 2,
        stat_right = 3,
        ...
        description = '紺浪文様の甲冑に佩刀、静かな眼光の若武者。上は隙あり。',
        description_en = 'Wave-patterned armor and a katana—sharp gaze, but soft along the top.',
        no = 18,
    },
    {
        card_id = 'tcg_c_mushroom',
        name = '翠瓶の錬金術師',
        name_en = 'Emerald Flask Alchemist',
        rank = 'C',
        type = 'free',
        stat_top = 3,
        stat_right = 2,
        ...
        description = '試験管と薬草の鞄、輝く緑の滴を掲げる旅錬金術師。右は防ぎ薄め。',
        description_en = 'Field alchemist with vials and herbs—glowing green brew in hand, weak to the right.',
        no = 19,
    },
    {
        card_id = 'tcg_c_ghost_jelly',
        name = '碧珀の獅子騎士',
        name_en = 'Sapphire Lion Knight',
        rank = 'C',
        type = 'free',
        stat_top = 2,
        stat_right = 2,
        ...
        description = '肩甲に獅子、蒼珀を嵌めた誇り高き若騎士。上・右は伸びしろあり。',
        description_en = 'Ornate plate with lion pauldrons and sapphires—proud youth, room to grow top-right.',
        no = 20,
    },
    {
