    ...
    openBook() {
      ...
      return {
        ...
        data: {
          ...
          match_history: [
            {
              match_id: 'pvp_mock_hist_1',
              finished_at: Math.floor(Date.now() / 1000) - 3600,
              reason: 'normal',
              opponent_display: 'Mock Opponent',
              opponent_citizenid: 'license:xxxxxxxxxxxxxxxx',
              outcome_me: 'win',
              score_me: 7,
              score_opp: 3,
              rating_me_before: 1600,
              rating_me_after: 1618,
              defeat_copy_received: false,
              defeat_copy_card_id: null,
            },
            {
              match_id: 'pvp_mock_hist_2',
              finished_at: Math.floor(Date.now() / 1000) - 86400,
              reason: 'normal',
              opponent_display: '',
              opponent_citizenid: 'license:yyyyyyyyyyyyyyyy',
              outcome_me: 'lose',
              score_me: 2,
              score_opp: 8,
              rating_me_before: 1618,
              rating_me_after: 1598,
              defeat_copy_received: true,
              defeat_copy_card_id: 'free_001',
            },
          ],
          ui: {
