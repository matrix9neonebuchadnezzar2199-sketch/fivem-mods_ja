...
(function (global) {
  ...
  const STR = {
    ja: {
      ...
      battle_log_head: 'ログ',
      battle_log_first_you: '先攻: あなた',
      battle_log_first_cpu: '先攻: CPU',
      battle_log_you_cell: 'あなた: マス {cell} に配置',
      battle_log_cpu_placed: 'CPU がランダムに配置しました',
      battle_log_match_end: '終了: あなた {h} vs CPU {c}',
    ...
    en: {
      ...
      battle_log_head: 'Log',
      battle_log_first_you: 'First: You',
      battle_log_first_cpu: 'First: CPU',
      battle_log_you_cell: 'You: placed on cell {cell}',
      battle_log_cpu_placed: 'CPU placed randomly',
      battle_log_match_end: 'End: You {h} vs CPU {c}',
