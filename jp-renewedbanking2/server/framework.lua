--[[
    Renewed-Banking / server/framework.lua
    原作: uShifty (Renewed-Scripts) — CC BY-NC-SA 4.0
    QB / QBX / ESX 向けのプレイヤー・ジョブ・資金操作の抽象化
]]
...
CreateThread(function()
    ...
    if Framework == 'qb' then
        ...
        -- 後方互換: qb-management の export 名をこのリソースの関数へ橋渡し
